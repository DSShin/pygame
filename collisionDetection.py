...
foods = []
for i in range(20):
    foods.append(pygame.Rect(random.randint(0, WINDOWWIDTH - FOODSIZE), random.randint(9, WINDOWHEIGHT - FOODSIZE), FOODSIZE, FOODSIZE))
...
while True:
    ...
    if bouncer['rect'].left < 0:
        ...
        if bouncer['dir'] == UPLEFT:
            bouncer['dir'] = UPRIGHT
    if bouncer['rect'].right > WINDOWHEIGHT:
